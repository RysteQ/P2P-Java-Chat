...
public class GUI implements ActionListener{	
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == addIpButton) {
			if((!newIPField.getText().equals(("Enter new chat IP"))) && (!newIPField.getText().equals(("")))) {
				if((!newNameField.getText().equals(("Enter new chat name"))) && (!newNameField.getText().equals(("")))) {
